...
# ---- CONFIG ----
path = "/home/rasmus-storm/Desktop/tests/14_04_bias_estimation/video_20/dataset_25"
csv_path = f"{path}.csv"
...
p_D_W_mocap = p_D_W_mocap[skip_frames:]
...
for p_d_w, q_d_w, p_l_c, q_l_c, r_g_g0 in zip(
    ...
    q_G_G0 = R.from_euler('XY', [r_g_g0[0] + 2.3, r_g_g0[1] - 1.3], degrees=True).as_quat()
